package nawatech.io.erp.utils.neptoengdate;

import java.util.ArrayList;
import java.util.List;

/**
 * <code>Lookup<code> is a simple class which has mapping from Bikram Sambat to
 * Gregorian date Current mapping is in range of 1970-2100 If you need extension
 * in date range, add more referring
 * <a href='http://www.ashesh.com.np/nepali-calendar/?'>Bikram Sambat Calendar.
 * Which has 1970-2100 bikram sambat date range
 *
 * @todo it would be better if these lookup tables could be maintained in XML or
 * JSON. easy change and change immediate There are certain year where
 * there is not 365 days per year, verify these year with other calendar.
 */
public class Lookup {
    /*
     ...
     */
    public static List<String[]> lookup = new ArrayList<>();
    ...
    /*
     * number of days in each month for subsequent years we need to extend this year
     * adding more entries
     */
    public static ArrayList<Integer[]> monthDays = new ArrayList<Integer[]>();

    static {
        monthDays.add(new Integer[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30});// 1970
        monthDays.add(new Integer[]{31, 31, 32, 31, 32, 30, 30, 29, 30, 29, 30, 30});// 1971
        monthDays.add(new Integer[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30});// 1972
        monthDays.add(new Integer[]{30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31});// 1973
        monthDays.add(new Integer[]{31, 31, 32, 30, 31, 31, 30, 29, 30, 29, 30, 30});// 1974
        monthDays.add(new Integer[]{31, 31, 32, 32, 30, 31, 30, 29, 30, 29, 30, 30});// 1975
        monthDays.add(new Integer[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31});// 1976
        monthDays.add(new Integer[]{30, 32, 31, 32, 31, 31, 29, 30, 29, 30, 29, 31});// 1977
        monthDays.add(new Integer[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30});// 1978
        monthDays.add(new Integer[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30});// 1979
        monthDays.add(new Integer[]{30, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31});// 1980
        monthDays.add(new Integer[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30});// 1981
        monthDays.add(new Integer[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30});// 1982
        monthDays.add(new Integer[]{31, 31, 32, 32, 31, 30, 30, 29, 30, 29, 30, 30});// 1983
        monthDays.add(new Integer[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31});// 1984
        monthDays.add(new Integer[]{31, 31, 31, 32, 31, 31, 29, 30, 30, 29, 30, 30});// 1985
        monthDays.add(new Integer[]{31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30});// 1986
        monthDays.add(new Integer[]{31, 32, 31, 32, 31, 30, 30, 29, 30, 29, 30, 30});// 1987
        monthDays.add(new Integer[]{31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 31});// 1988
        monthDays.add(new Integer[]{31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30});// 1989
