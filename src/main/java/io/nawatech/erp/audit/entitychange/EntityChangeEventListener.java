...
public class EntityChangeEventListener {
    ...
    public void onUpdate(Object entity) {
        ...
        List<EntityChangeDetail> changes = new ArrayList<>();
        ...
        for (Field field : entity.getClass().getDeclaredFields()) {
            ...
            try {
                ...
                if (!Objects.equals(oldVal, newVal)) {
                    EntityChangeDetail detail = new EntityChangeDetail();
        ...
        if (!changes.isEmpty()) {
            EntityChangeDetailInfo header = new EntityChangeDetailInfo();
            ...
            for (EntityChangeDetail d : changes) {
                d.setEntityChangeDetailInfo(header);
            }

            EntityChangeContext.add(header);
        }
    }
    ...
    public void onCreate(Object entity) {
        ...
        List<EntityChangeDetail> details = new ArrayList<>();
        for (Field field : entity.getClass().getDeclaredFields()) {
            if (HIBERNATE_FIELDS.contains(field.getName())) continue;
        ...
        if (!details.isEmpty()) {
            ...
            for (EntityChangeDetail d : details) {
                d.setEntityChangeDetailInfo(header);
            }
