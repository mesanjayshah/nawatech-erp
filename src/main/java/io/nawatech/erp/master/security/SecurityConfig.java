...
import io.nawatech.erp.master.multitenant.TenantResolverFilter;
...
public class SecurityConfig {
    ...
    @Bean
    public FilterRegistrationBean<TenantResolverFilter> tenantContextFilter(TenantResolverFilter filter) {
        FilterRegistrationBean<TenantResolverFilter> registration = new FilterRegistrationBean<>();
        registration.setFilter(filter);
        registration.setOrder(Ordered.HIGHEST_PRECEDENCE + 1); // BEFORE any DB access
        return registration;
    }
