function getCalendarDivString(t) {
    var e = '<div id="ndp-nepali-box" class="ndp-corner-all" style="display:none"><div class="ndp-nepali-box-inner">'
    return e += '<span id="ndp-target-id" style="display:none"></span>', e += '<div class="ndp-corner-all ndp-header">', e += '<a href="javascript:void(0)" id="prev" title="Previous Month" class="ndp-prev"></a>', e += '<a href="javascript:void(0)" id="next" title="Next Month" class="ndp-next"></a>', e += '<span id="currentMonth"></span>', e += "</div>", e += '<div id="npd-table-div">', e += "<table>", e += '<tr class="ndp-days">', e += "<th>आ</th>", e += "<th>सो</th>", e += "<th>मं</th>", e += "<th>बु</th>", e += "<th>बि</th>", e += "<th>शु</th>", e += "<th>श</th>", e += "</tr>", e += "</table>", e += "</div>", e += "</div>", e += "</div>"
}

$(document).on("click","#ndp-nepali-box",function(e){
    let container = $(".ndp-nepali-box-inner");
...
function showNdpCalendarBox(t) {
    if (0) hideCalendarBox(!1)
        ...
        var npdBoxRight = n.left + $("#ndp-nepali-box").outerWidth();
        var pLeft = npdBoxRight > windowWidth ? (n.left - (npdBoxRight - windowWidth)) : n.left;
        $("#ndp-nepali-box").css("top", n.top + $("#" + t).outerHeight()), $("#ndp-nepali-box").css("left", pLeft), showCalendar(e), npdCalendarVisible = !0
    }
}
...
function getMonthParameters(t) {
    ...
    var r = e[2], i = numberOfBsDays(n, a - 1), d = new NepaliDateConverter, o = a + "/1/" + n, h = d.bs2ad(o),
        p = h.split("-"), l = p[0], u = p[1], b = p[2], c = new Date(l, u - 1, b), g = c.getDay()
    return [g, i, n, a, r]
}
...
function getDayFromDate(t) {
    var e = t.split("-"), n = e[2], a = e[1], s = e[0], r = new Date(s, a - 1, n), i = r.getDay(),
...
function getDateInWords() {
    var t = getMonths(), e = new Date, n = e.getDate(), a = e.getMonth() + 1, s = e.getYear(),
        r = 1e3 > s ? s + 1900 : s
    return n + " " + t[a] + ", " + r
}
...
function count_ad_days(t, e) {
    ...
    var r = new Date(a[2], a[0] - 1, a[1]), i = new Date(s[2], s[0] - 1, s[1]),
        d = Math.ceil((i.getTime() - r.getTime()) / n)
    return d
}

function count_bs_days(t, e) {
    var n = t.split("/"), a = e.split("/"), s = +n[2], r = +n[0], i = +n[1], d = +a[2], o = +a[0], h = +a[1], p = 0,
        l = 0
...
ndpAttr = {}, npdCalendarVisible = "", npdIgnoreMouseUp = !1, ndpData = [], function (t) {
    t.fn.nepaliDatePicker = function (e) {
        e = void 0 !== e ? e : {}, ndpAttr = e, this.each(function () {
            ...
            // commented below line to prevent hideCalendar on select box click in firefox
